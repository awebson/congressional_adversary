...
def export_parsed_skip_grams(
    ...
    def parse_skip_grams(doc: List[int]) -> Tuple[List[int], List[int]]:
        """
    ...
    for words in tqdm(speeches, desc='Parsing skip-grams'):
        ...
        center_ids, context_ids = parse_skip_grams(speech_in_word_ids)
